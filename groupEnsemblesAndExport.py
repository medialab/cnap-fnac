            ...
            if inv_id in inventory:
                if not skip:
                    if inv_id not in uniq_doubles:
                        ...
                        uniq_doubles[inv_id] = True
                skip = True
            else:
                inventory[inv_id] = True
